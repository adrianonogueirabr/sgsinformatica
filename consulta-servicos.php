...
<table  width="100%" class="table responsive">
    <tr>
 	...
 	<tr>
		<td><legend class="p-4 table-primary">Pesquisar Servicos</Legend></td>
	</tr>
	<tr>
		<td>
			...
			<div class="form-group col-md-2 col-sm-12">
				<a href="cadastro-servicos.php" class="btn btn-outline-success btn-block" role="button" aria-pressed="true">Registrar Servico</a>
			</div>	
