...
<table  width="100%" class="table responsive">
    <tr>
 	...
 	<tr>
		<td><legend class="p-4 table-primary">Pesquisar Pecas</Legend></td>
	</tr>
	<tr>
		<td>
			<form name="listagem" action="listagem-pecas.php" method="post">
			...
			<div class="form-group col-md-2 col-sm-12">
				<a href="cadastro-pecas.php" class="btn btn-outline-success btn-block" role="button" aria-pressed="true">Registrar Servico</a>
			</div>	
